...
const HeadphoneData = [
  {
    ...
    subtitle:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi quibusdam qui ut facere maiores, accusantium numquam repellat minima modi quis!",
    price: "₹100",
    modal: "Modal Brown",
    bgColor: "#8b5958",
  },
          ...
          <div className="flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px]">
            <div className="space-y-5 text-center md:text-left">
              ...
              <AnimatePresence mode="wait">
                <UpdateFollower
                  mouseOptions={{
                    backgroundColor: activeData.bgColor ?? "#000000",
                    zIndex: 9999,
                    followSpeed: 0.5,
                    rotate: -720,
                    mixBlendMode: "difference",
                ...
                >
                  <motion.button
                    ...
                    animate="show"
                    exit="exit"
                    style={{ backgroundColor: activeData.bgColor ?? "#000000" }}
